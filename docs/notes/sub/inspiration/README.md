...
> While watching the video, the multiverse-oriented framing emerged as an independent conceptual direction before the video itself explicitly introduced a many-worlds interpretation.

This led to the first Ontoverse ideas around:
